...
//  Partner
//
//  Created by Macbook on 13/06/18.
...
public class CellAnimatorForCV {
    ...
    public class func animate(_ cell: UICollectionViewCell, withDuration duration: TimeInterval, animation type: AnimationType) {
