...
extension UIColor {
    ...
    static var themeCherry: UIColor { get { return UIColor(hex: "FF4545") } }
    
    static var themeGreen: UIColor { get { return UIColor(hex: "2AD179") } }
    
    static var themeOrange: UIColor { get { return UIColor(hex: "FF5C00") } }
    
    static var themeBlue: UIColor { get { return UIColor(hex: "033d6b") } }
    
    static var cellSelection: UIColor { get { return UIColor(hex: "A9BAEF") } }
    
    static var errorRed: UIColor { get {return UIColor(hex: "DF4848") } }
